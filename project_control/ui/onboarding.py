...
def _show_command_reference() -> None:
    ...
    print("  pc artifacts     — Find temporary screenshots and debug assets")
    print("  pc audits retention — Find stale generated audits and reports")
    print("  pc tui verify     — Run browser-based UI verification")
    print("  pc tui verify --list-profiles — List discovered UI verification profiles")
    print("  pc tui verify --profile <name> — Run a specific UI verification profile")
