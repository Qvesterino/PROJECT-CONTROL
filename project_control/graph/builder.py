...
class GraphBuilder:
    ...
    def build(self) -> Dict:
        ...
        resolver = SpecifierResolver(self.project_root, path_to_id.keys(), self.config.alias)
        edges = self._collect_edges(nodes, path_to_id, resolver)
    ...
    def _collect_edges(
        ...
        for path in node_paths:
            try:
                ...
                continue
            records = self.extractor.extract(content)
