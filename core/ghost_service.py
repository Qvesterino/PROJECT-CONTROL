...
from core.markdown_renderer import SEVERITY_MAP, render_ghost_report
...
def run_ghost(snapshot, patterns, args) -> GhostResult:
    """Execute ghost analysis and validate optional severity thresholds."""
    analysis = analyze_ghost(snapshot, patterns, mode=args.mode, deep=args.deep)
